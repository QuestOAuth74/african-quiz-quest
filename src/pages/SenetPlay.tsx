    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-950 dark:to-orange-950 p-4">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="block lg:hidden space-y-4">
          {/* Game Board for Mobile */}
          <div className="senet-board-container relative">
            <SenetBoard 
              gameState={gameState} 
              onSquareClick={handleSquareClick}
            />
            
            {/* Throwing Sticks positioned at bottom-right of board for mobile */}
            <div className="absolute bottom-4 right-4 z-10 mobile-throwing-sticks">
              <div className="bg-stone-900/95 backdrop-blur-sm rounded-lg border border-amber-600/30 p-3 shadow-lg">
                <ThrowingSticks
          ...
          {/* Other Controls Below Board for Mobile */}
          <div className="grid grid-cols-1 gap-4">
            ...
            <Card>
              ...
              <CardContent className="text-sm space-y-2">
                <p>• Throw the sticks to move your pieces</p>
                <p>• Navigate through the underworld path</p>
                <p>• Reach the afterlife before your opponent</p>
                <p>• Special squares have unique effects</p>
              </CardContent>
            </Card>
          </div>
        </div>
