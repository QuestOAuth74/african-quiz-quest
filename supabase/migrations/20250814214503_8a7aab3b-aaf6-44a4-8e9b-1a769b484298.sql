...
DROP FUNCTION IF EXISTS public.get_single_player_stats();

-- Create the updated function to return display_name instead of email
-- and generate random usernames for users without display names
